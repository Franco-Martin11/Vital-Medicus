...
const PoligonContainer: FC<poligonCta> = ({ children, title, route, direction }) => {
    return (
        <div className={`App w-[158px] h-[151px] ${direction === 'right' ? 'path-container' : 'path-container-left'} relative overflow-hidden bg-darkViolet rounded-[10px]  flex items-end justify-center p-3`}>
            {children}
